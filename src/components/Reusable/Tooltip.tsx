...
function TooltipButton({ description }: TooltipProps) {
  return (
    <div className="relative inline-block">
      <button className="bg-red-500 text-gray-600 transition-colors duration-200 focus:outline-none dark:text-gray-200 dark:hover:text-blue-400 hover:text-blue-500">
        <svg
